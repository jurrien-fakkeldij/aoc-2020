...
func parseTile(lines []string) *Tile {
	stringID := strings.Split(lines[0], " ")[1]
...
func Day20() {
	fmt.Println("==============  Day20 =============")
	fmt.Println("==============  TEST  =============")
	output, _ := buildPuzzle(filereader.ReadFile("./input/day-20/test.txt"))

	if output == 20899048083289 {
		fmt.Println("Test succeeded:", output)
	} else {
		fmt.Println("Test failed:", output)
	}
	fmt.Println("============== OUTPUT =============")
	output, _ = buildPuzzle(filereader.ReadFile("./input/day-20/input.txt"))
	fmt.Println("CornerCalc: ", output)

	fmt.Println("Roughness: ", countRoughness(filereader.ReadFile("./input/day-20/input.txt")))

}

func countRoughness(lines []string) int {
